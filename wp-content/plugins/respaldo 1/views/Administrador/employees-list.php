                                ...
                                <td class="text-center px-3 py-3">
                                    <?php if ( ! empty( $emp_id ) ) : ?>
                                        <div class="d-flex gap-1 justify-content-center">
                                            ...
                                            <button type="button" class="btn btn-sm btn-danger btn-desactivar-empleado" data-id="<?= esc_attr($emp_id) ?>" data-nombre="<?= esc_attr($empleado->nombre . ' ' . $empleado->apellido) ?>">
                                                <span class="dashicons dashicons-no"></span> Desactivar
                                            </button>
                                        </div>
                                    <?php endif; ?>
                                </td>
