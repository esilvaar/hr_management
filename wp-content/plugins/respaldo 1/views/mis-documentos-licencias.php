...
// Obtener documentos del empleado (solo Licencias)
// "licencia" deve coincidir con lo que se guarda en BD
            ...
            <div class="hrm-panel mb-3">
                <div class="hrm-panel-header">
                    ...
                    <small class="text-muted d-block mt-2">
                        <?= esc_html($employee->nombre . ' ' . $employee->apellido) ?> (RUT:
                        <?= esc_html($employee->rut) ?>)
                    </small>
                </div>
                <div class="hrm-panel-body">
                    ...
                    <div class="mb-4 pb-3 border-bottom">
                        ...
                        <div style="position: relative; max-width: 250px;">
                            <input type="text" class="form-control" id="hrm-mis-doc-year-filter-search"
                                placeholder="Buscar año..." autocomplete="off">
                            <div id="hrm-mis-doc-year-filter-items"
                                style="position: absolute; top: 100%; left: 0; width: 100%; background: white; border: 1px solid #dee2e6; border-top: none; max-height: 300px; overflow-y: auto; z-index: 1000; display: none;">
                            </div>
                        </div>
                    </div>
                                    ...
                                    <tbody>
                                        <?php foreach ($documents as $doc): ?>
                                            <tr data-year="<?= esc_attr($doc->anio) ?>">
                                                ...
                                                <td>
                                                    <a href="<?= esc_url($doc->url) ?>" class="btn btn-sm btn-outline-primary"
                                                        target="_blank" rel="noopener noreferrer" title="Descargar documento">
                                                        <span class="dashicons dashicons-download"></span> Descargar
                                                    </a>
                                                    <button type="button" class="btn btn-sm btn-secondary btn-preview-doc ms-2"
                        ...
                        <?php else: ?>
                            <div class="alert alert-info text-center py-4">
                                <span class="dashicons dashicons-media-document"
                                    style="font-size: 48px; opacity: 0.5;"></span>
                ...
                <div class="mt-4" id="hrm-preview-panel" style="display:none;">
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        ...
                        <button type="button" id="btn-cerrar-preview"
                            class="btn btn-sm btn-outline-secondary">Cerrar</button>
                    </div>
                    <iframe id="hrm-preview-iframe" src=""
