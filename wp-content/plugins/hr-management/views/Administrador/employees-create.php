                ...
                <fieldset class="hrm-form-section mb-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input id="hrm_email" name="email" type="email" class="form-control" required>
                        </div>
                    </div>
                        ...
                        <fieldset class="hrm-form-section mb-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input id="hrm_fecha_ingreso" name="fecha_ingreso" type="date" class="form-control" required title="Fecha de ingreso a la empresa">
                                </div>
                            </div>
