        ...
        <div class="mt-auto pt-2">
            ...
            <details <?= $section === 'perfil' ? 'open' : ''; ?>>
                ...
                <ul class="list-unstyled px-2 mb-2">
                    ...
                    <li>
                        <a class="nav-link px-3 py-2 <?= hrm_sup_is_active('hrm-mi-documentos'); ?>"
                           href="<?= esc_url( admin_url('admin.php?page=hrm-mi-documentos') ); ?>">
                            Mis Documentos
                        </a>
                    </li>
                    <li>
                        <a class="nav-link px-3 py-2 <?= hrm_sup_is_active('hrm-mis-documentos-contratos'); ?>"
                    ...
                    <li>
                        <a class="nav-link px-3 py-2 <?= hrm_sup_is_active('hrm-mis-documentos-liquidaciones'); ?>"
                    ...
                    <li>
                        <a class="nav-link px-3 py-2 <?= hrm_sup_is_active('hrm-mis-documentos-licencias'); ?>"
